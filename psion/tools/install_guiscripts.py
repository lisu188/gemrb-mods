...
def _patch_spell_pressed(text: str) -> str:
    ...
    hook = (
        ...
        '\t\tentry = None\n'
        '\t\t# Opcode 214 uses the synthetic type 255. Resolve those entries only\n'
        '\t\t# from spellinfo: their small child indices can collide with ordinary\n'
        '\t\t# memorized Psion spell indices and would otherwise charge a parent.\n'
        '\t\tif encoded_type == 255:\n'
        '\t\t\tfor candidate in Spellbook.GetSpellinfoSpells(pc, encoded_type):\n'
