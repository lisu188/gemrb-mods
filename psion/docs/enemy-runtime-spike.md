...
`ForceSpellRES("PS3THOP",Player1)` action, observes the actual non-party accepted-cast
callback, requires the INT-18 executable resource `PS3THOP4`, checks three PP are
